    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4" >
                ...
                <x-jet-input type="text" class="w-full" wire:model="post.title"></x-jet-input>
                <x-jet-input-error for="title"/>
            </div>
            <div class="mb-4" >
                <x-jet-label value="Contenido del post"/>
                <textarea type="text" class="form-control w-full" wire:model.defer="post.content" rows="6"></textarea>
